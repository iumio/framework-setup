...
window.onload = function () {
    document.getElementById("furl").innerHTML = (getBaseUrl())+env_file+"/index";
    document.getElementById("furl2").href = (getBaseUrl())+env_file+"/index";
}
...
$(document).ready(function () {
    ...
    $("#continues4").click(function () {
       ...
       if (typeof appname[1] == "undefined" ||  !isNaN(appname[1])) {
           $("#error1").show();
       }
        else if (appname === "App" || appname.length <= 3 ||  !isValid(appname)) {
           $("#error1").show();
       }
...
function setRecapGlobal() {
    ...
    if ((framework[2]).toLowerCase() == "beta")
        $("#betastage").show();
}
...
function redirect() {
    setTimeout(function () {
        location.href= (getBaseUrl())+'../'+env_file+"/index";
    }, 5000);
}
